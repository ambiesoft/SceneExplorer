...
Q_CONSTEXPR char APPVERSION[] = "1.22.43";
...
Q_CONSTEXPR char KEY_THUMBNAIL_WIDTH[] = "thumbwidth";
Q_CONSTEXPR char KEY_THUMBNAIL_HEIGHT[] = "thumbheight";
Q_CONSTEXPR char KEY_THUMBNAIL_SCROLLMODE[] = "thumbscrollmode";

Q_CONSTEXPR char KEY_TASK_PRIORITY[] = "taskpriority";

Q_CONSTEXPR char KEY_TAGMENU_FORMAT[] = "tagmenuformat";
...
Q_CONSTEXPR char KEY_RENAME_DIALOGGEOMETRY[] = "renamedialoggeometry";
...
Q_CONSTEXPR int THUMB_WIDTH_DEFAULT=240;
Q_CONSTEXPR int THUMB_HEIGHT_DEFAULT=180;
